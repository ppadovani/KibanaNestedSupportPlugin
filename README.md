...
The 'Discover Settings' management section requires that the user be able to search the indices
that they wish to prioritize the summary line of. Therefore make sure that the user
administrating is able to search.
